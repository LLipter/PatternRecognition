...
Assume I have ten attributes for each person. **Age**, **height**, **weight** and **salary** are numeric attributes. **sex** and **is_married** are binary attributes. **Ethnic**, **hair_color** and **eye_color** are nominal attributes. **Education_background** is ordinal attribute.
